...
const BookingForm = () => {
  ...
  return (
    <div className="booking_form-page w-[750px] h-[1995px]">
      <div className="booking_form-page--header bg-neutral-800 text-white flex h-[218px] items-baseline px-[50px] py-[34px]">
        <p className="block text-5xl text-left">Choose the form of payment</p>
        <IconClose className="mr-[6px]" />
      </div>
      <div className="booking_form-page--content p-[50px]">
        <div className="user-auth-part w-[650px] h-[164px] border-solid border rounded-[20px] border-[#D3DEE9] flex items-center px-[37px] py-[39px]">
          ...
          <div className="user-auth-info ml-[26px] flex flex-col">
            <p className="text-[40px] leading-[54px] text-left font-[600] mb-[4px]">
              {user.name}
            </p>
            <span className="text-[26px] min-w-[200px] leading-[35px] text-[#718096] font-[500] text-left">
              {user.phone_number}
            </span>
          </div>
          <button class="ml-[121px] rounded-[10px] text-[26px] leading-[35px] bg-[#EDF2F7] flex items-center justify-center w-[142px] h-[90px]">
            Log Out
          </button>
        </div>
        <div className="service-selected-part mt-[50px] ">
          ...
          <div className="user-auth-part mt-[40px] w-[650px] h-[240px] border-solid border rounded-[20px] border-[#D3DEE9] flex items-center px-[37px] py-[39px]">
            <img
              ...
              src="../assets/images/jp_lesson.png"
              alt=""
            />
            ...
            <div className="ml-[26px] flex flex-col">
              ...
              <div className="text-[20px] leading-[27px] text-left  text-[#718096] font-[500] flex mb-[12px]">
                <CalendarIcon className="mr-[6px]" />
                <p className="ml-[14px]">{selectedService.date}</p>
              </div>
              <div className="text-[20px] leading-[27px] text-left  text-[#718096] font-[500] flex mb-[12px]">
                <LocationIcon className="mr-[6px]" />
        ...
        <div className="location-part mt-[40px] ">
          ...
          <input
            ...
            className="w-[650px] h-[100px] border-solid border rounded-[20px] border-[#D3DEE9] mt-[20px] px-[28px] placeholder:text-[30px] placeholder:text-[#D3DEE9]"
          />
        </div>
        <div className="location-part mt-[40px] ">
          <h3 className="text-left font-[700] text-[40px] leading-[54px]">
        ...
        <div className="payment-part mt-[50px] ">
          ...
          <form className="payment-check flex mt-[50px]">
        ...
        <div className="checkout-part flex justify-between	 h-[160px] items-baseline px-[50px] py-[30px] mt-[107px] border-solid border-t-2  border-[#D3DEE9]">
          ...
          <button class="text-white rounded-[10px] mb-[20px] text-[26px] leading-[35px] bg-[#1E21FF] flex items-center justify-center w-[240px] h-[100px]">
            Next
          </button>
        </div>
      </div>
